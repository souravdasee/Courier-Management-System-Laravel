<ul class=" text-sm border font-medium text-center text-gray-500 rounded-2xl p-1 shadow-2xl flex dark:divide-gray-700 dark:text-gray-400">
    ...
    <li class="w-full">
        <a href="/status/deliver" class="{{ request()->is('status/deliver') ? 'inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 rounded-lg active focus:outline-none dark:bg-gray-700 dark:text-white' : 'inline-block w-full p-4 bg-white border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 rounded-lg focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700'}}">Deliver</a>
    </li>
    <li class="w-full">
