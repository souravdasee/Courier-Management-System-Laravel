                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="/book" method="POST" id="booking">
                        ...
                        <div class="p-2">
                            ...
                            <input type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="sender_name" placeholder="(E.g. John Doe)" value="{{ old('sender_name') }}"
                                required>
                        ...
                        <div class="p-2">
                            ...
                            <input type="text"
                                ...
                                placeholder="(E.g. Mark Miller)" required>
                        ...
                        <div class="p-2">
                            ...
                            <input
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="number" name="weight" value="{{ old('weight') }}" step="0.01"
                                placeholder="max upto 50Kg & in 2 decimals" required>
                        ...
                        <div class="p-2">
                            ...
                            <input type="number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="sender_number" id="sender_number" placeholder="(E.g. 9876543210)"
                        ...
                        <div class="p-2">
                            <label for="recipient_number">Recipient's Phone Number:<span
                                    class="text-red-500">*</span></label>
                            <input type="number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="recipient_number" value="{{ old('recipient_number') }}" id="recipient_number"
                        ...
                        <div class="p-2">
                            ...
                            <div class="">
                                <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" name="from" value="{{ old('from') }}" id="startLocation"
                                    placeholder="(E.g. Farakka Barrage)" oninput="autoFill('start')" required>
                                <div class="absolute z-auto rounded bg-gray-300 dark:bg-gray-700 max-h-40 overflow-y-auto w-auto autocomplete-items autocomplete-items-hover"
                                    id="startAutocomplete"></div>
                            </div>
                        </div>
                        ...
                        <div class="p-2">
                            ...
                            <div class="">
                                <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="text" name="to" value="{{ old('to') }}" id="endLocation"
                                    placeholder="(E.g. kolkata)" oninput="autoFill('end')" required>
                                <div class="absolute z-auto rounded bg-gray-300 dark:bg-gray-700 max-h-40 overflow-y-auto w-auto autocomplete-items autocomplete-items-hover"
                                    id="endAutocomplete"></div>
                            </div>
                        </div>
                        ...
                        <div class="p-2">
                            ...
                            <textarea
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="sender_address" required>{{ old('sender_address') }}</textarea>
                        ...
                        <div class="p-2">
                            ...
                            <textarea type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                name="recipient_address" required>{{ old('recipient_address') }}</textarea>
                        ...
                        <input type="button" value="Get Distance" onclick="getDirections()"
                        ...
                        <div class="p-2">
                            ...
                            <div>
                                <textarea id="distance" name="distance"
                                    class="dark:bg-gray-800 text-black dark:text-white w-full h-10 p-2 border-hidden" readonly></textarea>
                            </div>
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            <li class="inline-flex items-center">
                                <a href="/dashboard"
                                    class="inline-flex items-center text-sm font-medium text-blue-500 hover:text-red-600 dark:hover:text-yellow-500">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400">Payment</span>
                                </div>
                            </li>
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Checkout</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
