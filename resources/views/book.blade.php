                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="/book" method="POST" id="booking">
                        ...
                        <div class="p-2">
                            ...
                            <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="sender_name" placeholder="(E.g. John Doe)" value="{{ old('sender_name') }}" required>
                        ...
                        <div class="p-2">
                            ...
                            <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" name="weight" value="{{ old('weight') }}" step="0.01" placeholder="max upto 50Kg & in 2 decimals" required>
                        ...
                        <div class="p-2">
                            ...
                            <input type="number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="sender_number" id="sender_number" placeholder="(E.g. 9876543210)" value="{{ old('sender_number') }}" required>
                        ...
                        <div class="p-2">
                            ...
                            <div class="">
                                ...
                                <div class="absolute z-auto rounded bg-gray-300 dark:bg-gray-700 max-h-40 overflow-y-auto w-auto autocomplete-items autocomplete-items-hover" id="startAutocomplete"></div>
                            </div>
                        </div>
                        ...
                        <div class="p-2">
                            ...
                            <div class="">
                                ...
                                <div class="absolute z-auto rounded bg-gray-300 dark:bg-gray-700 max-h-40 overflow-y-auto w-auto autocomplete-items autocomplete-items-hover" id="endAutocomplete"></div>
                            </div>
                        </div>

                        <div class="p-2">
                            <p>Sender's Full Address<span class="text-red-500">*</span></p>
                            <textarea class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="sender_address" required>{{ old('sender_address') }}</textarea>
                        ...
                        <div class="p-2">
                            ...
                            <textarea type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="recipient_address" required>{{ old('recipient_address') }}</textarea>
                        ...
                        <input type="button" value="Get Distance" onclick="getDirections()" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800" />

                        <div id="map" class="h-96 w-full rounded-2xl hidden"></div>
                        <div class="p-2">
                            <label for="distance">Distance (in km)</label>
                            <div><textarea id="distance" name="distance" class="dark:bg-gray-800 text-black dark:text-white w-full h-10 p-2 border-hidden" readonly></textarea></div>
