        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    ...
                    @endif
                    @if (request()->user()->role === 'Data Entry')
                        <a href="{{ url('/status') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                    @endif
                    @if (request()->user()->role === 'Delivery Agent')
                        <a href="{{ url('/delivery') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                    @endif
            ...
            <div class="mt-16">
                <div
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Track item</h2>
                        ...
                        <div class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            <form action="/tracking" method="GET">
                                ...
                                @enderror
                                <button
                                    class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Track</button>
                            </form>
                        </div>
                    </div>
                </div>
