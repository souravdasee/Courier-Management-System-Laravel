                        ...
                        <form action="/status/dispatch" method="post">
                            ...
                            <div class="flex mb-2">
                                <textarea name="current_location" id="placeName"
                                    class="w-full hidden bg-gray-50 dark:bg-gray-800 text-black dark:text-white border-none" readonly>{{ $locations[0]->city }}</textarea>
                            </div>
                            ...
                            <div>
                                <input type="text" name="current_status" value="Dispatched" class="hidden" readonly>
