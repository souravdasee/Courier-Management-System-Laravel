<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="rounded-2xl border text-gray-900 dark:text-gray-100">
                    ...
                    <form action="/edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="p-2 flex">
                            <label for="placeName" class="my-auto">Current Location:
                                {{ $checkouts->current_location }}&nbsp;</label>
                            <textarea
                                class="bg-gray-50 border w-96 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" name="current_location" id="placeName">{{ $locations[0]->city }}</textarea>
            ...
            <a href="/status"><button type="button"
