<nav x-data="{ open: false }"
    class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 sticky top-0 inset-x-0 sm:justify-start z-50 w-full text-sm py-3 sm:py-0">
        ...
        <div class="flex justify-between h-8 sm:h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @enddelivery
                    @operator
                        <x-nav-link :href="route('receive_item_status')" :active="request()->routeIs(
                            'status',
                            'statusupdate',
                            'receive_item_status',
                            'deliver_item_status',
